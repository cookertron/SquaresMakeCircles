...
SQUARE_IMAGE = pygame.Surface((100, 100)) # Créer une nouvelle surface d'image.
SQUARE_IMAGE.set_colorkey((0, 0, 0)) # Définissez la couleur de transparence, dans ce cas, ce sera le noir.
SQUARE_IMAGE.fill(FILL_COLOR) # Remplissez l'image avec la couleur de remplissage.
pygame.draw.rect(SQUARE_IMAGE, LINE_COLOR, (0, 0, 100, 100), 1) # Dessinez un rectangle pour créer la bordure du carré.
